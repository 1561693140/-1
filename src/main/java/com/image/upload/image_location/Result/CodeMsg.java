package com.image.upload.image_location.Result;
...
public class CodeMsg {
	...
	public static CodeMsg ACCESS_LIMIT_REACH = new CodeMsg(500103, "访问太频繁了");
	public static CodeMsg NOT_LOG_IN = new CodeMsg(500104, "未登录");
	//登录模块 5002XX
	...
	public static CodeMsg USERNAME_EMPTY = new CodeMsg(500216, "用戶名为空");
	public static CodeMsg USERNAME_NOT_EXIST = new CodeMsg(500217, "用戶名不存在");
